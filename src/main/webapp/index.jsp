<%@page import="com.af.knowledgehub.auth.AuthHelper"%>
	...
	<div class="readme">
		...
		<ul>
			...
			<li>Set up allowed Redirect URIs at Google API &rarr; API
				Access. Input: http://localhost:8080/index.jsp</li>
		...
		<ol>
			<li>Add Client ID, and Client Secret parameters to <b>AuthHelper.java</b></li>
